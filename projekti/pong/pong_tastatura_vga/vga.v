...
// Pong sa PS/2 tastaturom i VGA monitorom
// radjeno uz pomoc PS/2 i VGA ekipa
...
//=======================================================
	...
	always @(posedge CLOCK_50) begin
		...
		if (vga_bhrojac >= 0 && vga_bhrojac < 800) begin
			...
			// crno polje 512x512 (samo sto bude razvuceno na displeju zbog skaliranja)
			...
			begin
				...
				VGA_G = 8'hff;
				VGA_B = 8'hff;
			end // magija, ne dirati
			
			// if ( vga_bhrojac >= // ovu liniju smo krenuli da kucamo ali je zapravo prethodna stvar odradila posao zbog logike koju smo koristili oko multipleksiranja
