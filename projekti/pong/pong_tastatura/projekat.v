...
// Pong sa PS/2 tastaturom, sklapano u saradnji sa PS/2 ekipom
...
//=======================================================
	...
	ps2parse tastature(PS2_CLK, PS2_DAT, buttons, keyreg); // modul za tastaturu od ps/2 ekipe
	keys dugmici(sekunda, pom1, pom2, buttons, game, first, game2); // key handler za dugmice koji kontrolisu
